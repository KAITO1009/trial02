$(document).ready(function(){
    ...
    $('.btn').on('mouseover', function(){
        ...
        switch($id){
            case "btn1":
            $('.titleimg').attr('src', 'img/title1.jpg');
            $('.titleimg').fadeIn();
            break;
            case "btn2":
            $('.titleimg').attr('src', 'img/title5.png');
            $('.titleimg').fadeIn();
            break;
            case "btn3":
...
$(function(){
    ...
    $('.headerbtn').each(function(){
         ...
         $(this).on('click',function(event){
            ...
            switch($id){
                case "btn1":
                $(el).animate({scrollTop:section1OffsetTop},250);
                break;
                case "btn2":
                $(el).animate({scrollTop:section2OffsetTop},250);
                break;
                case "btn3":
                $(el).animate({scrollTop:section3OffsetTop},250);
                break;
                case "btn4":
                $(el).animate({scrollTop:section4OffsetTop},250);
                break;
            };
         });
    });
